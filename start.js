...
return {
conversation: 'WhatsApp Bot By YASSxOFC'
}}})
...
if (connection == 'open') {
Sky.sendMessage(Sky.user.id.split(":")[0] + "@s.whatsapp.net", {text: `${`*#- SimpleBotz Version 5.0.0*

Jangan lupa untuk mengikuti Channel developer -> https://youtube.com/@YASSxOFC sehingga Anda bisa mendapatkan update terbaru tentang ini script :)`.toString()}`})
